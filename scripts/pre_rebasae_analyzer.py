...
def parse_args():
    ...
    parser.add_argument("-kernel_json_path", nargs='+', type=str, default="", required=True,
                        help="Path for KERNEL Json with pre-rebase process results")
    parser.add_argument("-ofed_json_path", type=str, default=None, required=True,
...
def main():
    ...
    args = parse_args()
    file_list_verify = []
    file_list_verify.extend(args.kernel_json_path)
    file_list_verify.append(args.ofed_json_path)
